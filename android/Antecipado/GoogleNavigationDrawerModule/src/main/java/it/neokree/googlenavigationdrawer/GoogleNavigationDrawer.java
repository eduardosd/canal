...
public abstract class GoogleNavigationDrawer<Fragment> extends ActionBarActivity implements GSectionListener {
    ...
    public void setFragment(Fragment fragment, String title, Fragment oldFragment) {
        ...
        if (fragment instanceof android.app.Fragment) {
            ...
            if ( accountListener != null ) {
                accountListener.openFragment((android.support.v4.app.Fragment) fragment);
            }
    ...
    public void setCurrentAccount(GAccount currentAccount) {
        this.currentAccount = currentAccount;
    }

    public List<GSection> getSectionList() {
        return sectionList;
    }
